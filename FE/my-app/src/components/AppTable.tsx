...
export default function AppTable(props: IProps) {    
    ...
    console.log(blogs);
    const handleAddBlog = (newBlog: { title: string; author: string; content: string }) => {  
    ...
    return (
        <>
            <div className="flex justify-between mb-2">
                ...
                <button onClick={() => setIsModalOpen(true)} className="border-2 py-2 px-4 bg-green-200">Add</button>
            </div>
                            ...
                            <React.Fragment key={index}>
                                <tr>
                                    ...
                                    <td className="border border-slate-700 flex gap-3">
                                        ...
                                        <button className="border-0 text-yellow-400">
                                            Edit
                                        </button>
